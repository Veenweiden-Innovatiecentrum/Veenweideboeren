...
*De vier labels die hoofdstuk 4 en 5 aan elkaar knopen, staan in `terminologie.md`: een **eis** zonder prijs (4.1) · een **wens** zonder eis (4.3) · een **opdracht**, waar de vraag hard is en de uitvoering bestaat maar de betaling nog kosten vergoedt (5.3, het weidevogelbeheer) · een **betaalde dienst**, waar een afnemer met een eigen begroting tegen een prijs inkoopt (5.3).*
...
### 5.3 Waar deze opgaven een betaalde dienst kunnen worden · **gehaald: 976 woorden, 745 leesregel** (was 789)
...
- **het grensgeval en de drie horden sluiten de sectie:** weidevogelbeheer als opdracht en niet als betaalde dienst, en dan kan het · mag het · wordt het gewild, met hun adres `[tekst · ingekort]`
...
## 6 — Wat er gebeurt als er niets verandert (scenario I) · bron: scenario-1 · ronde 2 · nu aan de beurt
...
### 6.2 Er wordt gestuurd op middelen · **gehaald: 299 woorden**, inclusief de effect-alinea
...
### 6.3 Waarom dit geen stabiele toestand is · **gehaald: 288 woorden**
...
- **de drie termijnen, in één alinea en niet als kaarten** (Tim, 20-8): op korte termijn sneuvelt het werk waarvoor geen rekening bestaat, op middellange termijn maakt de reflex om te groeien het landschap grover en verdwijnt het fijnmazige netwerk, en op lange termijn blokkeert de middengroep de omslag zelf omdat marge, buffer en perspectief ontbreken `[tekst · auteurs, ingedikt]` woordelijk klaar in `correctielijst.md`, vorm al gebouwd in commit `6a30ea3`. **De eerste kaart draagt de meetlat van hoofdstuk 5:** het weidevogelbeheer is de enige prestatie waarvoor de uitvoering vandaag staat, en het is het eerste dat sneuvelt
...
### 6.4 De motor · **gehaald: 290 woorden**
...
## 7 — Wat er gebeurt zonder verdienmodel eronder (scenario II) · bron: scenario-2 · ronde 2 · nu aan de beurt
...
### 7.2 De maatregelen kloppen, er ligt alleen niets onder · **gehaald: 448 woorden**, waarvan 2 fiches en de effect-alinea
...
### 7.3 Waarom de verbetering niet standhoudt · **gehaald: 238 woorden**
...
### 7.4 De motor · **gehaald: 245 woorden**
...
- scenario III is geen morele maar een ontwerpkeuze: een systeem dat van variatie profiteert in plaats van eraan onderdoor te gaan `[tekst · verhuisd]` uit hoofdstuk 5, geparkeerd 19-8
...
- het ontwerp moet voorkomen dat de stikstofaanpak scenario II wordt `[tekst · verhuisd]` uit de wachtkamer, besluit 18-8 — als eis en niet als oordeel
