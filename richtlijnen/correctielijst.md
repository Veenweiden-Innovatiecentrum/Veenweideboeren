...
- [ ] **Kaal "waterpeil" specificeren.** `terminologie.md` eist de grondwaterstand, het slootwaterpeil of beide, nooit alleen "waterpeil". Nog te doen in `d-concept` (regel ~38, 2×), `scenario-1` (regel ~14), `scenario-2` (het oude regel ~136) en `f-overheid` (regel ~64, 3×)
