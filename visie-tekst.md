...
<div style="background:var(--blue-light);border-left:3px solid var(--blue);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.5rem 0 0;font-size:13.5px;line-height:1.65">
    ...
    <p style="margin:0">Dit is het naslagdeel van de visie: de volledige redenering, met de cijfers, de bronnen en de afbakeningen erbij. Wie alleen de kern wil weten, kan bij de samenvatting blijven.</p>
