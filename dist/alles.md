...
<div style="background:var(--blue-light);border-left:3px solid var(--blue);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.5rem 0 0;font-size:13.5px;line-height:1.65">
    ...
    <p style="margin:0 0 .6rem">Drie aktes vormen de hoofdas: akte 1 (de situatie nu), akte 2 (ingrijpen zonder verdienmodel), akte 3 (oplossingsrichting). Door alle aktes lopen drie terugkerende kaders:</p>
...
<div style="background:var(--amber-light);border-left:3px solid var(--amber);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.5rem 0 0;font-size:13.5px;line-height:1.65">
    ...
    <p style="margin:0 0 .75rem">Het Rijk werkt aan een driesporenbeleid voor het veenweidegebied: (1) intensivering in urgentiegebieden — zones rond natuur, weidevogelkerngebieden, hoge emissies, bodemdaling — op ca. 45.000 ha (€400 mln, TF LNS pijler 2), (2) generieke peilfixatie op -40 cm op het resterende areaal van ca. 90.000 ha, geflankeerd door een GLB-hectarepremie, en (3) omschakeling naar extensieve, natuurinclusieve melkveehouderij op ca. 10% van het gebied (€900 mln voor 50% grondafwaardering). Totaal: een zichtbare claim van circa €1,3 miljard tot 2035.</p>
    <p style="margin:0">Deze veenweideboeren-aanpak is geschreven omdat dit beleid — hoe doordacht ook — het risico in zich draagt om precies het tegenovergestelde effect te bereiken van wat het beoogt. Peilverhoging plus compensatie zonder onderliggend verdienmodel duwt juist de boeren het gebied uit die nodig zijn om de opgaves daadwerkelijk te halen. Het geld is er. De vraag is of het de motor voedt, of dat het hem afzet.</p>
  </div>
...
<div style="background:var(--red-light);border-left:3px solid var(--red);border-radius:var(--radius);padding:1rem 1.25rem;margin:1.25rem 0;font-size:13px;line-height:1.6">
    ...
    De maatschappelijke opgaves worden niet gehaald zolang de middengroep klem zit. Geen enkele opgave — klimaat, water, natuur, landschap, kringloop — wordt structureel bereikt als 70-80% van de boeren in het veenweidegebied geen ander perspectief heeft dan doormodderen of stoppen. De waarneming uit vergelijkbare beleidscycli — uitkoopregelingen 2008–2020, eerste-generatie stikstofmaatregelen — is dat harde maatregelen zonder onderliggend bedrijfsmodel het beoogde effect niet bereiken; eerder versnellen ze de uitstroom van precies de boeren die nodig zijn voor de oplossing.
  </div>

Dat is waarom dit verhaal drie aktes heeft. Akte 1 laat zien wat er gebeurt als het systeem doordraait: de middengroep krimpt, en de maatschappelijke opgaves worden niet gehaald. Akte 2 laat zien wat er gebeurt als de overheid ingrijpt met harde maatregelen maar de systeemcondities niet verandert: de klem wordt erger, de middengroep verdwijnt sneller, en de opgaves worden tijdelijk iets beter maar structureel niet gehaald. Akte 3 laat zien wat er mogelijk wordt als je de drie systeemcondities wél aanpakt — grondmarkt, beleidskader en ketenstructuur tegelijk — zodat de middengroep een nieuw perspectief krijgt: veenweideboer worden, met een verdienmodel dat de opgaves als business benut.
...
De boer is niet het probleem, de boer is de motor. Waterkwaliteit, biodiversiteit, broeikasgasreductie: ze worden pas bereikbaar als de boer er een verdienmodel in ziet. Niet ondanks ondernemerschap, maar dankzij. Mits de overheid de juiste condities schept.
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin:1.25rem 0">
    ...
    <div style="background:var(--bg3);border:1px solid rgba(0,0,0,.06);border-radius:var(--radius-lg);padding:1.5rem;border-top:3px solid var(--blue)">
      ...
      <div style="margin-bottom:14px">
        ...
        <div style="color:var(--text2);font-size:12.5px;line-height:1.5">Per context en per bedrijf, in opgaande ladder. Eerst op bedrijfsniveau — een vieze sloot mag bestaan zolang het water het erf schoon verlaat; te warme percelen mogen bestaan zolang elders genoeg koolstof wordt vastgehouden. Daarna op polderniveau — wat de ene boer niet haalt, kan een ander binnen hetzelfde pijlvak compenseren tegen vergoeding. Daarna op collectiefniveau, waar de totale opgave wordt afgerekend. Bedrijfsniveau alleen werkt niet: ongelijke percelen en veendiktes maken individuele afrekening met één generieke norm onnodig destructief.</div>
      </div>
...
De kern van het probleem zit in hoe we het veenweidebedrijf definiëren. Zolang het formeel wordt gezien als een regulier melkveebedrijf met extra beperkingen, blijft één maatstaf dominant: **maximale melkproductie per hectare**. Binnen dat kader is de boer automatisch in het defensief. Hij wordt beoordeeld op wat hij níét haalt en gezien als iemand die, ondanks alle noodzakelijke beperkingen, toch probeert te blijven produceren. Daarmee wordt hij impliciet onderdeel van het probleem.
...
<div class="akte akte-1" id="akte1">
    ...
    <p>De CO₂-uitstoot is hoog en dubbel. Enerzijds de bodememissies: midden in de percelen blijft het droog, de boeren zijn niet genegen het waterpeil te verhogen, en dat diepe, droge veen oxideert continu. Anderzijds de bedrijfsemissies: veel koeien op stal betekent veel methaan, veel zware machines op grote percelen betekent veel CO₂.</p>
    ...
    <p>De boer verdient nog steeds, maar de marges worden dunner. De schaal compenseert wat de prijs per liter niet meer doet.</p>
    <div class="dim-list">
      <div class="dim-item"><span class="dot red"></span><span class="name">Klimaat &amp; bodemdaling</span><span class="desc">Diepe ontwatering, hoge veenoxidatie, bodememissies stijgen</span></div>
      <div class="dim-item"><span class="dot red"></span><span class="name">Klimaat (bedrijf)</span><span class="desc">Veel vee op stal, veel zware machines, hoge methaan- en CO₂-uitstoot</span></div>
...
<div class="akte akte-2" id="akte2">
  ...
  <div style="background:var(--bg3);border:1px solid rgba(0,0,0,.08);border-left:3px solid var(--blue);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.25rem 0;font-size:13.5px;line-height:1.65">
    ...
    <div style="margin:1.5rem 0 1rem">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
        ...
        <div style="background:var(--bg3);border:1px solid rgba(0,0,0,.06);border-radius:var(--radius);padding:1rem 1.25rem;font-size:13px;line-height:1.55">
          ...
          <div style="color:var(--text2)">Reguliere melkveehouderij blijft mogelijk. Vernatting werkt hier met WIS als instrument en aangepast graslandbeheer. Geen andere typologie nodig. De veenweideboeren-aanpak is daar niet voor bedoeld. <strong>Het probleem is hier instrumenteel:</strong> hectarepremie compenseert grond in plaats van diensten te belonen, en generieke peilfixatie pakt de zuinige boer (zie hieronder).</div>
        </div>
    ...
    <div style="background:var(--amber-light);border-left:3px solid var(--amber);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.25rem 0;font-size:13.5px;line-height:1.65">
      <strong style="display:block;margin-bottom:6px;font-size:14px">Generieke peilfixatie pakt de zuinige boer</strong>
      <p style="margin:0 0 .75rem">Niet elk veen emitteert evenveel. Percelen die al laag liggen zijn doorgaans natter en stoten minder broeikasgassen uit dan hoog gelegen percelen. Generieke peilfixatie binnen een pijlvak raakt boeren met overwegend laaggelegen percelen — die nu al weinig uitstoten — even hard als boeren met hoge percelen die veel meer uitstoten. De zuinige boer betaalt. Zonder kartering en differentiatie binnen pijlvakken is dat moeilijk verdedigbaar.</p>
      <p style="margin:0"><strong>Water naar boven, rust op de rest.</strong> Hoog gelegen percelen stoten het meest uit en lijden het meest onder droogteschade — daar zit de winst van actief watermanagement. Lage natte percelen kunnen vaak met rust gelaten worden. Differentiatie binnen pijlvakken benut die kennis; generieke peilfixatie negeert haar.</p>
    </div>
    ...
    <p><strong>De boodschap:</strong> De overheid stelt de juiste doelen maar geeft de ondernemer niet de middelen om ze te halen. De maatregelen versnellen precies de trend die ze moesten stoppen: de lokale boer verdwijnt, het rentmeesterschap verdwijnt, en daarmee het fundament onder alle dimensies.</p>
  </div>
...
<div class="akte akte-3" id="akte3">
    ...
    <p>Het begint moeizaam. De familieondernemer maakt de lastige overstap: minder koeien, ander landgebruik, nieuwe vaardigheden. De eerste jaren zijn kwetsbaar — daarvoor staat de transitie-infrastructuur klaar. Het bedrijfsmodel staat na 7-10 jaar volwaardig. Maar anders dan in akte 2 blijft de boer op het land. En met hem het rentmeesterschap: de liefde voor het land, de kennis van elk perceel, de zorg voor de slootkanten.</p>
    <h4>Wat je dan ziet veranderen</h4>
    <p>De bouwstenen worden beschikbaar. Elke ingezette bouwsteen verandert het landschap én verbetert de opgaves. Maar nu werken de veranderingen mét de boer in plaats van tegen hem.</p>
    <p>De CO₂-uitstoot daalt, beide bronnen. De bodememissies verminderen omdat de boer natte teelt en koolstofopslag als verdienmodel inzet: het waterpeil midden in de percelen gaat omhoog omdat het nu loont. De bedrijfsemissies nemen af omdat het bedrijf anders is opgezet: minder maar beter vee, minder zware machines, lagere emissies per hectare. Waterkwaliteit verbetert, niet door normering alleen, maar omdat ecologisch slootbeheer weer de moeite waard is. Waterkwantiteit verbetert ook: wateropslag op het bedrijf wordt een bouwsteen, de boer buffert water lokaal en wordt betaald voor wateropslag als dienst. Natuur keert terug, niet als verplichting die hectares inneemt, maar omdat biodiversiteitsdiensten en natuur als dienst het rentmeesterschap weer rendabel maken.</p>
    ...
    <div class="dim-list">
      ...
      <div class="dim-item"><span class="dot green"></span><span class="name">Klimaat (bedrijf)</span><span class="desc">Lagere veedichtheid: minder vee, minder zware machines, lagere emissies per hectare</span></div>
...
De veenweideboer bepaalt zelf hóe hij zijn doelen haalt. Dit zijn de bouwstenen: de toolbox waarmee de boer zijn doelen haalt. Niveau 1 optimaliseert het bestaande bedrijf. Niveau 2 opent nieuwe inkomstenstromen.
...
<p style="font-size:13.5px;color:var(--text2);line-height:1.65;margin-top:.5rem">De drie rijen rond natuur en biodiversiteit hangen samen maar dekken drie verschillende dingen. <strong>Functionele biodiversiteit</strong> op niveau 1 (kruidenrijk grasland, weidevogelbeheer, bloemrijke randen) versterkt de bedrijfsvoering en levert stabielere, kwalitatief betere opbrengst; dat is geen verdienmodel maar een waardevolle bedrijfsbasis. <strong>Natuur als dienst</strong> gaat een stap verder: het inrichten en beheren van natuur met expliciete natuurdoelstellingen en -eigenschappen, verkoopbaar als opdracht aan overheid of marktpartij. <strong>Biodiversiteitsdienst</strong> is een nieuwere benadering waarbij biodiversiteit zelf wordt geproduceerd en verkocht, via overheidsopdracht, marktopdracht of de biodiversiteitscreditmarkt. De drie zijn nauw met elkaar verbonden maar conceptueel onderscheiden; alleen de laatste twee zijn verdienmodellen.</p>
...
<div style="background:var(--bg3);border:1px solid rgba(0,0,0,.08);border-left:3px solid var(--blue);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.25rem 0;font-size:13.5px;line-height:1.65">
    ...
    <p style="margin:0">Akte 3 borgt anders dan via overheidsbezit. Prestatiecontracten zijn juridisch bindend, betaling alleen bij geleverde prestatie. De boer heeft eigen economisch belang bij voortzetting: stopt hij met leveren, dan stopt zijn inkomen. Borging zit deels in toezicht, deels in de bedrijfsstructuur zelf. De handhavingskosten blijven hoger dan bij uitkoop — maar de drager van het gebied blijft, gebonden aan prestatie, met eigen belang bij naleving.</p>
  </div>
...
<p style="font-size:13px;color:var(--text2);margin-bottom:1rem">De motor financieel voeden. Zonder structurele inkomenszekerheid neemt geen ondernemer het risico om te transiteren.</p>
...
<div style="background:linear-gradient(135deg, #1a4d18 0%, #2d6a23 100%);color:#fff;border-radius:var(--radius-lg);padding:1.5rem 1.75rem;margin:2rem 0 0;box-shadow:0 2px 8px rgba(0,0,0,.08)">
    ...
    <p style="font-size:15.5px;line-height:1.5;margin:0 0 .5rem;font-weight:500">De veenweideboer als toekomstbestendige ondernemer die maatschappelijke diensten levert — en daarmee de motor wordt voor klimaat, water, natuur, voedselzekerheid, cultuur &amp; landschap, grondstoffen &amp; kringloop en wonen.</p>
    <p style="font-size:12.5px;line-height:1.5;margin:0;color:rgba(255,255,255,.85);font-style:italic">Onder deze visie ontwikkelt het VIC drie parallele rollen voor de komende jaren.</p>
  </div>

<div style="text-align:center;margin:-2px 0;font-family:sans-serif;font-size:18px;color:var(--accent)">▼</div>

<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin:1.5rem 0 2rem">

    <div style="background:var(--bg3);border:1px solid rgba(0,0,0,.06);border-top:3px solid var(--blue);border-radius:var(--radius-lg);padding:1.25rem">
      <div style="font-size:10px;text-transform:uppercase;letter-spacing:.08em;color:var(--blue);margin-bottom:.5rem;font-weight:600">Rol 1 — Beleid</div>
      <h3 style="margin-top:0;font-size:17px;color:var(--blue)">Ruimte scheppen</h3>
      <p style="font-size:13.5px;font-weight:600;color:var(--text);margin-bottom:.75rem;line-height:1.4">Helpen ruimte en kaders creëren voor de nieuwe typologie veenweideboeren.</p>
      <p style="font-size:13px;color:var(--text2);line-height:1.55;margin:0 0 1rem">Op beleidsniveau, langs drie lijnen: financieel, juridisch en opgaven-technisch. Bijvoorbeeld: opdrachtverstrekking voor maatschappelijke diensten als zakelijke transactie. Niet als lobbyist, maar als inhoudelijke gesprekspartner — het VIC kent het veld, de boer en de opgave, en die kennis hoort in de beleidsdiscussie. Daaronder valt ook de marktinfrastructuur: certificeringsstandaarden, taxatiekaders voor veenweidegrond, juridische ruimte voor waterdienst- en biodiversiteitsarrangementen. Zonder die kaders kunnen zuivelketens, banken en afnemers van maatschappelijke diensten hun rol niet pakken.</p>
      <div style="border-top:1px solid rgba(0,0,0,.08);padding-top:.75rem">
        <div style="font-size:10px;text-transform:uppercase;letter-spacing:.06em;color:var(--blue);font-weight:600;margin-bottom:4px">Status</div>
        <div style="font-size:12px;color:var(--text2);line-height:1.5">Nieuwe expliciete rol. Gebeurt nu al impliciet — gesprekken met strategische beleidsmedewerkers — maar verdient eigen status en zichtbaarheid binnen het VIC-programma.</div>
      </div>
    </div>

    <div style="background:var(--bg3);border:1px solid rgba(0,0,0,.06);border-top:3px solid var(--accent);border-radius:var(--radius-lg);padding:1.25rem">
      <div style="font-size:10px;text-transform:uppercase;letter-spacing:.08em;color:var(--accent2);margin-bottom:.5rem;font-weight:600">Rol 2 — Perspectief</div>
      <h3 style="margin-top:0;font-size:17px;color:var(--accent2)">Perspectief leveren</h3>
      <p style="font-size:13.5px;font-weight:600;color:var(--text);margin-bottom:.75rem;line-height:1.4">Bewijs leveren voor perspectief — voor agrarische ondernemers én maatschappij.</p>
      <p style="font-size:13px;color:var(--text2);line-height:1.55;margin:0 0 1rem">Op drie vlakken: sociaal, technisch en zakelijk. Bijvoorbeeld: kloppende business cases gestoeld op technisch werkende pilots. JUMP heeft de verkenningen gedaan — nu is het tijd om de belofte hard te maken. Bij hoge grondwaterstand verslempt klei en glijdt, maar veen mét grasmat blijft koeien dragen — een contra-intuïtief inzicht dat het bedrijfsmodel pas mogelijk maakt. En omdat de grasproductie op deze gronden structureel lager ligt dan op conventionele landbouwgrond, zijn extra inkomstenstromen uit maatschappelijke diensten geen optie maar voorwaarde. Het perspectief geldt drie partijen: boer (verdienmodel), maatschappij (opgaves gehaald) én bedrijfsleven (waar zit hun business case in veenweidemelk, waterdiensten of credits?). Zonder zicht op die derde business case blijft de markt afwachten.</p>
      <div style="border-top:1px solid rgba(0,0,0,.08);padding-top:.75rem">
        <div style="font-size:10px;text-transform:uppercase;letter-spacing:.06em;color:var(--accent2);font-weight:600;margin-bottom:4px">Status</div>
        <div style="font-size:12px;color:var(--text2);line-height:1.5">Dit is precies het JUMP-programma, met het mogelijke vervolg BASE. Bestaande programmatische lijn van het VIC, hier expliciet ingebed in het bredere rollenmodel.</div>
      </div>
    </div>

    <div style="background:var(--bg3);border:1px solid rgba(0,0,0,.06);border-top:3px solid var(--amber);border-radius:var(--radius-lg);padding:1.25rem">
...
{{partial:i-vic-rol-visual-1}}

<div style="background:var(--bg2);border-radius:var(--radius-lg);padding:1.5rem 1.75rem;margin:1.5rem 0 2rem;border-left:4px solid var(--accent)">
    <h4 style="margin:0 0 .5rem;color:var(--accent2)">Van visie naar programmavoorstel</h4>
    <p style="font-size:14px;color:var(--text2);margin:0;line-height:1.6">Deze drie rollen zijn niet sequentieel — ze lopen gelijktijdig en versterken elkaar in een causale cirkel. Ruimte schept de voorwaarden waaronder business cases kloppen. Perspectief wekt het vertrouwen dat boeren en gebiedsmanagers in beweging brengt. Beweging levert het politieke bewijs dat de gemaakte ruimte de juiste keuze was — en versterkt zo de bereidheid om méér ruimte te scheppen. Samen vertalen ze de visie naar wat ondernemers, gebiedsmanagers en beleidsmakers nu nodig hebben om akte 3 mogelijk te maken. Dat is wat de volgende fase van het VIC-programma vraagt: drie parallele rollen, één gedeeld doel.</p>
  </div>

<div style="background:var(--bg3);border:1px solid rgba(0,0,0,.06);border-radius:var(--radius-lg);padding:1.5rem 1.75rem;margin:1.5rem 0 2rem;border-left:4px solid var(--blue)">
