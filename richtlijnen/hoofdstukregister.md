...
| b-opgaves | 4 | 2 | **herzien** (19-8), en teruggebracht tot de vraag: 4.1 de zeven opgaven, 4.2 de twee dossiers van vandaag. 794 woorden tegen 802 in de bestuursversie. Geen markering open; het verlies-deel is naar akte I belegd en het ondernemer-argument naar 5.5 |
| c-omslag | 5 | 1 | herzien; **19-8 heringericht op Tims vierslag**: 5.1 wat het nu levert · 5.2 wat er nog meer kan · 5.3 waarom hier · 5.4 de drie horden · **5.5 en dit gaat niet op vrijwilligheid** (verhuisd uit het oude 4.2). Nog toe te voegen: drie bronnen en één getal, de lijst staat in `correctielijst.md` onder c-omslag |
