## Programma — €15 mln over vier jaar (te valideren)

<div style="background:var(--bg3);border:1px solid rgba(0,0,0,.08);border-left:3px solid var(--amber);border-radius:var(--radius);padding:1rem 1.25rem;margin:0 0 1.5rem;font-size:13px;line-height:1.6">
...
<p style="font-size:13px;color:var(--text2);line-height:1.6">De drie rollen lopen parallel, alle vier de jaren — maar niet in gelijke verhouding. Rol 1 (beleid) is in het begin het grootst en neemt af naarmate het kader staat; rol 3 (beweging) begint kleiner en groeit naarmate er meer over te dragen valt. Geen van beide gaat naar nul. Rol 2 (perspectief) blijft constant het zwaartepunt; daarbinnen verschuift de bewijsvoering van JUMP naar BASE, naar bewijs leveren, naar verankeren.</p>
...
<div style="margin:1rem 0 .5rem;font-size:12px;line-height:1.4">
  ...
  <div style="display:flex;align-items:stretch">
    <div style="width:110px;flex-shrink:0;display:flex;flex-direction:column;justify-content:space-between;padding:6px 0;font-weight:600;font-size:12px"><span style="color:var(--blue)">Rol 1 — Beleid</span><span style="color:var(--amber)">Rol 3 — Beweging</span></div>
    <div style="flex:1;position:relative;height:120px;border-radius:var(--radius);overflow:hidden">
      <div style="position:absolute;inset:0;background:var(--blue);clip-path:polygon(0 0, 100% 0, 100% 28%, 0 70%);color:#fff;padding:.6rem .75rem">Agenderen en beïnvloeden — zwaar in het begin, daarna afbouwend maar nooit weg</div>
      <div style="position:absolute;inset:0;background:var(--amber);clip-path:polygon(0 72%, 100% 30%, 100% 100%, 0 100%);color:#fff;padding:.6rem .75rem;display:flex;align-items:flex-end;justify-content:flex-end;text-align:right">Intermediairs toerusten en activeren — groeit naarmate er meer over te dragen valt</div>
    </div>
  </div>
</div>
