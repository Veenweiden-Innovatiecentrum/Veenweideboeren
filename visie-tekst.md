...
<div style="background:var(--bg3);border:1px solid rgba(0,0,0,.08);border-left:3px solid var(--accent);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.5rem 0 2rem;font-size:13.5px;line-height:1.65">
    ...
    <p style="margin:0 0 .75rem"><strong>De analyse: drie scenario's.</strong> Scenario I — doorgaan op de huidige weg — houdt de uitstoot onverminderd hoog en holt het rentmeesterschap uit. Scenario II — de huidige maatregelen en plannen: peilfixatie, normering, compensatie — lijkt aanvankelijk te werken: het peil stijgt, de cijfers verbeteren. Maar de verbetering keert. Precies de boeren die de opgaves moeten dragen worden het gebied uitgeduwd; wat overblijft zijn beheerders op afstand. In brede zin worden de opgaves juist níet gehaald. Scenario III hanteert dezelfde maatregelen en dezelfde doelen, maar legt er de pijlers onder die van de boer een ondernemer maken.</p>
...
<div style="background:var(--bg3);border:1px solid rgba(0,0,0,.06);border-radius:var(--radius-lg);padding:1.25rem 1.5rem;margin:1.5rem 0 0">
  ...
  <table style="width:100%;border-collapse:collapse;font-size:13px;line-height:1.55">
    ...
    <tr><td style="padding:.3rem .75rem .3rem 0;white-space:nowrap;vertical-align:top"><strong>Scenario's (I, II, III)</strong></td><td style="padding:.3rem 0;color:var(--text2)">De drie verhaallijnen van dit document: doorgaan op de huidige weg (I), ingrijpen zonder pijlers (II), ingrijpen mét pijlers (III). Romeinse cijfers, altijd.</td></tr>
...
### 5.3 Waar deze opgaven een betaalde dienst kunnen worden
...
<p style="margin:0 0 .75rem">Hoofdstuk 5 eindigt op wat er nodig is. Naast het product melk kan een betaalde dienst staan, en daarvoor is een ondernemende boer nodig die de investering wil doen. Of het zover komt, beslist die boer niet alleen. Het hangt aan twee dingen die buiten het bedrijf worden bepaald: waarop de overheid stuurt, en of er voor die tweede dienst betaald wordt.</p>
<p style="margin:0 0 .75rem">Aan die tweede vraag hangt de manier van betalen. Vandaag loopt het geld als steun: een vergoeding die kosten dekt, aangevraagd en verantwoord. Wordt de dienst ingekocht, dan loopt het als een opdracht: een prijs voor een benoemde prestatie. Dat is de omslag waarop dit document rust, en bewezen is zij niet; hoofdstuk 2 zet haar neer als aanname 1. Wat zij oplevert reikt verder dan de drie eisen waarop wordt gehandhaafd, want wie voor een dienst betaald wordt, levert onderweg ook de opgaven waar Nederland om vraagt zonder ze op te leggen.</p>
...
<p>Op het land is dat te zien: egaal groen grasland zonder veel variatie, kaarsrechte sloten zonder begroeiing, en percelen die groter zijn geworden doordat sloten zijn gedempt en kavels samengevoegd. Er lopen relatief veel koeien, verspreid over de percelen, want het blijft droog genoeg om ze buiten te laten, en de stal is uitgebreid. De boer staat er zelf, en het bedrijf leeft van één prijs: die van de melk. De tankauto rijdt vol weg.</p>
<p>Onder het land blijft de grondwaterstand laag en blijft het veen droog, dus de uitstoot uit de bodem gaat door. Met veel vee blijft ook de methaanuitstoot hoog.</p>
...
<p>En dan houdt het stand, waar het in scenario II juist keerde. Daar verbeterden klimaat, water en natuur eerst en liep de verbetering daarna terug, omdat de mensen verdwenen die het beheer deden waarop zij rustte. Hier blijven zij, en zij hebben er een reden voor die niet alleen uit gehechtheid bestaat: er staat een verdienvermogen tegenover. Dat is het verschil tussen een doel dat op papier gehaald wordt en een doel dat gehaald blijft.</p>

### 8.4 De motor

De motor draait op de juiste brandstof. De opgaven zijn hier geen kostenpost maar het werk waaraan het bedrijf verdient: schoon water, vastgehouden koolstof, weidevogels, landschapskwaliteit. Wat daar tegenover staat is een prijs voor een geleverde dienst, en geen vergoeding voor wat er is ingeleverd. Daarmee trekt de motor de opgaven mee in plaats van ertegenin te werken.

<p>Het is niet een ander type ondernemer dan in scenario I, het is dezelfde ondernemer die bréder wordt. In scenario I was hij een handelsgerichte schaaloptimalisator, gericht op uniformiteit en volume, met het land als productiemiddel voor de bulkmarkt<span class="fiche-wrap"><button class="fiche-btn" type="button" aria-label="Bron tonen">ⓘ</button><span class="fiche-popup"><span class="fiche-label">Bron</span><span class="fiche-source">ZuivelNL, Blik op Zuivel 2026: ca. 75% van de Nederlandse zuivelafzet blijft binnen de EU (waarvan ca. 40% binnen Nederland); ca. 25% gaat naar o.a. China, de VS en het VK.</span></span></span>. Hier komt daar een tweede lijn bij: gebiedsgericht en verbonden, met diversiteit en lokale binding als verdienprincipe.</p>
...
<!-- ======== bestand: content/scenario-vergelijking.md ======== -->

---

## 9 — Wat de drie scenario's naast elkaar opleveren
...
Bovenop de verplichte maatregelen zijn dit de condities die de overheid moet faciliteren om scenario III mogelijk te maken. Ze werken alleen als systeem, je moet op zes niveaus tegelijk bewegen: maatregelen, doelen, juridische ruimte, vangnet, opdrachten en coördinatie. Als je er maar één pakt, trekt het oude systeem de verandering weer terug. Twee aantekeningen vooraf: de overheid is hier geen enkelvoudige entiteit — Rijk (LVVN, IenW, BZK), provincie, waterschap en gemeente dragen elk afzonderlijke pijlers of delen daarvan, en welke laag wat doet vergt aparte uitwerking. En dit document raamt geen kosten — de orde-van-grootte vereist eigen werk samen met het ministerie van Financiën; op enkele plekken zijn bestaande referentiepunten zichtbaar (ANLb-groei, koolstofcredit-tarieven).

<div style="background:var(--amber-light);border-left:3px solid var(--amber);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.25rem 0;font-size:13.5px;line-height:1.65">
    <strong style="display:block;margin-bottom:6px;font-size:14px">Driesporenbeleid, drie van de vier pijlers ontbreken</strong>
    <p style="margin:0">Het driesporenbeleid dekt vrijwel uitsluitend cluster 1: inkomen en zekerheid, en dan ook nog in compensatie-logica (hectarepremie, opkoop, afwaardering). De andere drie clusters blijven onderbelicht of afwezig: markttoegang (veenweidezuivelketen, koolstof- en biodiversiteitsmarkt), grond en ruimte (Nationale Grondbank, veenweidecategorie in het omgevingsplan, juridische ruimte voor natte teelt en paludicultuur), en organisatie en financiering (gebiedsregie via collectieven, transitiesteun). Zonder deze drie clusters is spoor 3 een eenzame poot, een ambitie zonder instrumentarium. Het verschil tussen "scenario II voor 90.000 ha + scenario III voor 20.000 ha" en een dragend veenweide-systeem zit precies in deze ontbrekende pijlers.</p>
  </div>
...
Scenario III staat of valt met meer dan overheid en boer. Het verdienmodel bestaat alleen als de markt aan de andere kant aansluit: de afnemers van melk, de financiers van de bedrijfsovergang, en — nieuw en cruciaal — de afnemers van de maatschappelijke diensten zelf. Zonder die derde laag blijft scenario III een papieren constructie. Het bedrijfsleven is daarin geen passieve toehoorder maar actor: drie groepen schuiven aan, elk met een eigen handelingsperspectief.
...
Scenario III is geen garantie. Dezelfde goedbedoelde beleidslogica die scenario II deed mislukken, kan ook scenario III ondermijnen, als de onderliggende systeemkrachten niet worden aangepakt. Negen risico's om scherp op te zijn.
