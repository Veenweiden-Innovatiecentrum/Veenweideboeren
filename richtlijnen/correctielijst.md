...
*De marge-alinea's en het ondernemer-argument staan nu in **5.5**; het verlies-deel is bij **akte I** belegd, zie de e-aktes-lijst hieronder. Wat hier staat afgevinkt, is dus verwerkt maar niet meer in dit hoofdstuk te vinden.*
...
- [x] **De drie termijnen zijn als `decision-card` gebouwd en met het verlies-deel naar akte I meegegaan**, gestapeld: label, kernzin, en de alinea van de auteurs eronder. Niet in drie kolommen, want dan geldt de eis van gelijke lengte uit `bloktypen.md` en zijn de drie 45, 80 en 75 woorden
- [x] **Het rode kader "Zonder perspectief geen opgaves" is lopende tekst geworden en gaat mee naar akte I** (`bloktypen.md`: dit ís de conclusie van B), met "doormodderen" vervangen door "doorgaan zoals het is" (besluit 18-8, toetsregel 1)
- [x] **"opgaves" is "opgaven"** in het hele hoofdstuk (`terminologie.md`)
- [x] **De boemerang uit redactiebrief §3 is geschreven en gaat mee naar akte I:** de onbeprijsde uren, niet gratis maar onbeprijsd, en één zin over de afwendbaarheid en niet meer dan één
...
*Op 20-8 uit `e-aktes.md` gesplitst; `e-aktes.md` bestaat niet meer. Wat alleen akte II raakt staat hieronder onder `akte-2.md`, wat alleen het gedeelde eindbeeld raakt onder `akte-3.md` — daar staat de partial.*

- [ ] **Dimensietabel akte I**: waterkwantiteit van groen naar oranje *(Niel)*
- [ ] **Verhuisd uit `b-opgaves` op 19-8, voor akte I (hoofdstuk 6, ronde 2): het hele verlies-deel van het oude 4.2.** Tims herordening zet het ondernemer-argument achter de kansen (5.5), en wat er dan overblijft beschrijft wat er gebeurt als er niets verandert. Dat is akte I. Drie stukken, en 6.2 "wat dat betekent per opgave" is de plek:
...
- [ ] **Drie van de negen driesporenblokken staan er nu.** De andere zes staan nog in `akte-2` (4×), `f-overheid` en `g-perspectief` en komen hier bij elkaar, waarna de negen tot één doorlopende bijlage worden samengevoegd
