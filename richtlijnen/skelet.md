...
- **de sectie opent op de koppeling met 4.1 en dan komen de drie termijnen.** Eerst: de vraag is reëel en op één punt wordt er al aan geleverd, want er ligt weidevogelbeheer met pakketten en collectieven, maar dat is het deel waarvoor een regeling bestaat en het meeste beheer staat in geen enkel contract. Dat hangt aan één voorwaarde die niet in de tabel staat: een ondernemer die het doet en het kan blijven doen. Daarna de drie termijnen: margedruk vernietigt het rentmeesterschap, de schaalvergrotingsreflex maakt de fijnmazigheid kapot, en zonder investeringsruimte komt de omslag niet van de grond `[tekst + kaarten · auteurs + nieuw]` **De koppeling is nieuw** (Tim, 19-8) en zij lost een tegenspraak op die er anders staat: 4.1 zegt dat het beheer bestaat en de collectieven het uitvoeren, 4.2 zegt dat het beheer als eerste sneuvelt. Het verschil is beprijsd tegenover onbeprijsd, en dat moet één keer gezegd worden vóór de drie termijnen. De drie zelf worden `decision-card`, gestapeld en niet in kolommen, want zij zijn niet even lang en de eis van gelijke lengte uit `bloktypen.md` geldt de kolomvorm
