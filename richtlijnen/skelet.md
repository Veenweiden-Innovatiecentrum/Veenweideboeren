# Skelet — koppen en elementen, vóór de woorden
...
| | |
|---|---|
| `[tekst]` `[tabel]` `[lijst]` `[kaarten]` `[fiche]` `[kader]` `[beeld]` | welke vorm het krijgt, conform `bloktypen.md` |
| `· auteurs` | de tekst bestaat al in de bestuursversie en wordt gewijzigd, niet herschreven |
| `· nieuw` | hier moeten woorden gemaakt worden, en dat is het duurste soort werk |
| `· verhuisd` | komt uit een ander hoofdstuk, met de vindplaats in `correctielijst.md` |

Dit bestand is de enige plek waar het skelet staat. `build.py site` schrijft het per hoofdstuk in de lezer, boven de tekst, zodat de koppeling zichtbaar blijft. Het verdwijnt met dezelfde schakelaar als de werkstandregel.
...
- twee aanleidingen: de gebiedsspecifieke aanpak en het stikstofdossier `[tekst · nieuw]`
- de beperkingen zijn nodig; dit is geen alternatief maar een manier om het te laten slagen `[tekst · nieuw]`
- wij vragen geen euro uit de lopende middelen, wel de ruimte om de volgende ronde te bouwen `[tekst · nieuw]`

### 1.3 Over welk deel van het gebied
- op het grootste deel is geen groot probleem en kan melkveehouderij regulier doorgaan `[tekst · auteurs]`
- de redenering geldt tóch voor het hele gebied, en de juridische ruimte ook `[tekst · nieuw]`
- op 20 tot 30% stapelen vier vormen van fysieke druk; op een klein deel is geen vee meer mogelijk `[lijst + tabel]`
...
*De orde is omgedraaid ten opzichte van de bestuursversie, die eerst de blokkade beschrijft en daarna de opgaven. Op 19-8 is het hoofdstuk teruggebracht tot de vraag alleen, op Tims vierslag: 1 het is lastig voor de veehouder (hoofdstuk 3) · 2 tegelijk vraagt Nederland veel van dit gebied (dit hoofdstuk) · 3 maar er blijkt veel meer te kunnen (hoofdstuk 5) · 4 en dat gaat niet op vrijwilligheid, dus is er een ondernemende boer met een verdienmodel nodig (5.4).*

*Op **20-8 is het hoofdstuk in drieën gedeeld en geordend naar dwang** (Tim): 4.1 wat moet, 4.2 wat nu het hardst duwt, 4.3 wat ook gevraagd wordt zonder dat het moet. **Waarom die ordening:** de producten van hoofdstuk 5 komen precies uit de zachte categorie, dus de lezer moet het verschil tussen een eis en een wens al kennen voordat hij in 5.3 komt. De harde opgaven kosten productie, de zachte kunnen iets opbrengen — en dat verschil is in één platte lijst van tien dimensies niet te zien. Dit is ook waar het document naartoe werkt: er bestaat vandaag geen categorie "gevraagde prestatie mét prijs", en dat is het gat dat de visie wil vullen.*

*De tien dimensies verdelen zich over 4.1 en 4.3, en er komt er geen bij: **drie hard, zeven zacht**. **De splitsing loopt langs lijnen die er al waren.** Water, natuur én klimaat vielen al in twee dimensies uiteen, en in alle drie de gevallen staat de harde tegenover de zachte kant: de Kaderrichtlijn Water tegenover waterberging, Natura 2000 tegenover de basiskwaliteit van het boerenland, en de bodememissies tegenover de uitstoot van het bedrijf. Zeven opgaven, tien dimensies — Simons telling blijft dus staan.*

***Klimaat — bedrijf is 20-8 van hard naar zacht gegaan** (Tim, online nagetrokken): Nederland heeft géén norm per bedrijf voor methaan of broeikasgas, alleen een sectordoel met jaarlijkse monitoring. De enige harde norm die het stikstofpakket van 26 juni 2026 aan de melkveestal oplegt is 0,164 kilo **ammoniak** per fosfaatrecht in 2035, en ammoniak dient de natuuropgave. Denemarken doet wél wat de zin suggereerde: vanaf 2030 een heffing op de broeikasgasuitstoot van vee, €16 per ton naar €40 in 2035. **Wat de verhuizing oplevert:** de drie harde dimensies vallen nu één-op-één samen met de drieslag in de openingsalinea — klimaat, natuur, waterkwaliteit.*

### 4.1 Wat er moet, en waar het het zwaarst is · **gehaald: 371 woorden** (was 538; drie harde dimensies, waarvan 115 woorden tabelcel van de auteurs)
...
- de drie harde dimensies, met per stuk wat Nederland vraagt en waar die vraag het zwaarst is: klimaat en bodemdaling · waterkwaliteit · Natura 2000 `[tabel · auteurs]` drie van de tien rijen uit de bestaande tabel, cellen ongewijzigd. De drie correcties van 19-8 blijven staan: de KRW bij waterkwaliteit (toetsregel 24) en "beschermde soorten" bij de basiskwaliteit (Simon), die daarmee in 4.3 landt
...
### 4.2 Welk dossier nu het hardst duwt · **gehaald: 397 woorden**, waarvan 121 fiche (was 250)

*Op 20-8 op Tims verzoek rijker gemaakt: van één dossier naar een tijdlijn van drie. Reden: "ze zijn allemaal best wel van belang, alleen in tijd krijgen ze minder aandacht en geld."*

- **nu duwt stikstof het hardst.** Geen achtste opgave maar de scherpe kant van de natuuropgave, en een lagere veedichtheid verlaagt de ammoniakuitstoot als gevolg van die stap zelf `[tekst · auteurs]` §6, toetsregel 22. **Tweede koppeling met 3.3:** daar is stikstof het dossier dat het bedrijf in één keer raakt
- **klimaat en bodemdaling duwt minder hard, en niet omdat de opgave kleiner werd.** Het doel staat — een megaton CO₂-eq minder in 2030 — maar de Klimaat- en Energienota 2025 rekent voor dat het sectordoel voor landgebruik ook met aanvullend beleid buiten bereik blijft, en zolang dat gat groeit valt er geen vergunning stil `[tekst · nieuw]` Tim, 20-8, online nagetrokken
- **wat eraan komt is de waterkwaliteit, en die heeft een datum.** De laatste planperiode van de Kaderrichtlijn Water eindigt in 2027 en verlenging is daarna niet mogelijk; in 2025 voldeed geen van de 745 oppervlaktewateren aan alle eisen `[tekst + fiche · nieuw]` Tim, 20-8. De cijfers, de inbreukprocedure van de Commissie over de vergunningverlening en het achtste Actieprogramma Nitraatrichtlijn staan in de fiche, niet in de lopende tekst
- **de conclusie is het mechanisme, en zij vervangt de oude brugzin:** wat een dossier hard laat duwen is niet de omvang van de opgave maar of er een juridisch slot op zit. Stikstof had er een, water krijgt er een, klimaat heeft er geen. Alle drie blijven even reëel; wat wisselt is welke de aandacht en het geld krijgt. Een bedrijf dat alleen op het dossier van vandaag is ingericht staat bij de volgende ronde opnieuw voor de vraag `[tekst · nieuw]` Tim, 20-8
...
*Waarom deze sectie er is, en de zachte dimensies niet gewoon in hoofdstuk 5 worden geïntroduceerd: hoofdstuk 4 is de volledige vraag, en een lijst die alleen de eisen noemt is niet eerlijk. Belangrijker is wat het 5.3 oplevert — die sectie zeeft dan drie producten uit een lijst die de lezer al heeft geaccepteerd, in plaats van een nieuwe claim te openen. **Harde voorwaarde: 4.3 blijft een opsomming en wordt geen uitwerking**, anders zeggen 4.3 en 5.3 hetzelfde twee keer.*

*Wat hier uit het hoofdstuk verdwijnt, en waarheen: **het hele oude 4.2**, dat is 19-8 gesplitst. De marge-alinea's en het ondernemer-argument zijn stap 4 en staan nu in 5.1 en 5.4. De drie termijnen, de areaal-claim met haar `[[CIJFER]]`, de conclusie "zonder perspectief geen opgaven" en de boemerang uit §3 gaan naar akte I, met hun tekst in `correctielijst.md`. Verder: de alinea die de drie aktes introduceert vervalt, want toetsregel 13 legt die ene introductie bij hoofdstuk 6, en "de middengroep krijgt een nieuw perspectief: veenweideboer worden" kan niet, dat is de lezer al · "niet omdat de boer het verkeerd doet, maar omdat het systeem alleen verkeerde opties biedt" is om, toetsregel 5a · de waarneming over eerdere beleidsronden verhuist naar hoofdstuk 7, waar besluit 17-8 haar als fiche belegt.*
...
*Hoofdstuk 4 is af op **1.070 woorden tegen 832 in de bestuursversie**, en 949 als je de fiche niet meerekent — die staat in de lezer als open te klikken kader en niet in de leesregel. Het budget van 650 is dus ruim gemist, en dat heeft drie oorzaken die alle drie de moeite waren. **Eén: de tabelrijen verhuizen, zij krimpen niet** — de tien rijen zijn 316 woorden van de auteurs en de splitsing over 4.1 en 4.3 scheelt daarin niets. **Twee: twee feitcorrecties van 20-8** (opgave versus maatregel, en klimaat-bedrijf dat geen harde eis blijkt) kostten woorden omdat de keten uitgeschreven moest worden. **Drie: 4.2 is op Tims verzoek bewust rijker gemaakt**, van één dossier naar een tijdlijn van drie plus het mechanisme dat ze ordent. Dat is 250 woorden erbij en het is het waard: het verklaart waarom een bedrijf meer dan één prestatie moet kunnen dragen, en dat is precies wat hoofdstuk 5 nodig heeft.* Het budget van 650 is niet gehaald, en de oorzaak is de moeite om te onthouden: **de tabelrijen verhuizen, zij krimpen niet.** De tien rijen zijn 316 woorden van de auteurs, en de splitsing over 4.1 en 4.3 scheelt daarin niets; ik had gerekend alsof zij dat wel zou doen. Van de 371 woorden in 4.1 zijn er 115 tabelcel, van de 293 in 4.3 zijn er 241 tabelcel. **Het proza is wél gedaald**, van 481 naar 464 woorden, terwijl er een sectiekop, een label, een brug en een aanloop bij kwamen, de weidevogel-alinea van 90 woorden eruit ging en de feitcorrectie van 20-8 de hele keten doel-maatregel-druk moest uitschrijven. Die alinea is 20-8 op Tims aanwijzing nog een keer strak gezet: van 155 naar 92 woorden, met de drie ketens als parallelle drieslag en zonder de negatie van mijn eigen fout. Verder snijden kan alleen door de tabelcellen van de auteurs te herschrijven, en dat is geen redactiekwestie. **Het woordtotaal van 20-8 is daarmee vervallen.** De belofte was 2.210 voor hoofdstuk 4 en 5 samen tegen 2.857; realistisch wordt het ongeveer 2.510 aan leesregel, dus ruim 340 korter in plaats van 640. De 554 woorden uit hoofdstuk 5 blijven wel staan: dat is proza dat het hoofdstuk verlaat en geen tabel die verschuift.*
...
### 5.2 De ruimte die vrijkomt · **gehaald: 113 woorden** (nieuw)

- **er komt ruimte vrij, en de sectie zegt meteen wat voor ruimte:** niet in hectares, want het bedrijf houdt zijn land, maar in wat dat land moet opbrengen — percelen die niet meer op een maximale grasopbrengst hoeven staan kunnen natter zijn, later gemaaid worden, iets anders dragen `[tekst · nieuw]` Tim, 20-8
- **en er komt ook ruimte in het verdienmodel:** het melkgeld valt weg, dus er is een gat dat gevuld moet worden `[tekst · nieuw]` de dubbele betekenis van "ruimte" is de kern: fysieke ruimte op het land én een gat in de omzet, en beide moeten gevuld
- **de vraag die daarmee opkomt, en de sectie eindigt op de vraag daarachter:** wat zou je op dat land kunnen doen dat past bij wat Nederland vraagt — want ruimte die leeg blijft is alleen een omzetverlies — en als er iets op past, betaalt iemand daarvoor? `[tekst · nieuw]` Tims twee keer "potentieel", maar met inhoud. **Bijgesteld 20-8 op zijn aanwijzing:** er stond "de kans is voorwaardelijk" en "wat erin komt is een keuze". Het eerste is een kwalificatie zonder te zeggen waarvan het afhangt, het tweede is een dooddoener want alles is een keuze. Wat het moest zeggen staat er nu als feit: leeg blijven is de rekensom van 3.2, dus minder omzet bij gelijke kosten. En de betaalvraag was ik bij het herschrijven kwijtgeraakt, terwijl die de brug naar 5.3 is — het "wél" in de openingszin van 5.3 hing zonder haar in de lucht

*Deze sectie is het scharnier van het hele document en zij is 20-8 twee keer geschreven. **Mijn eerste versie was mis en het is de moeite waard te weten waarom.** Die zei: dezelfde ingreep heeft twee uitkomsten — een hogere waterstand kost gras én stopt de veenoxidatie. Klopt feitelijk, maar dan is die tweede uitkomst automatisch, en iets automatisch hoeft niemand te betalen; dan zet een overheid gewoon het peil om. Dat argument werkt dus tegen 5.4 in. **Tims framing lost dat op:** er komt ruimte vrij en iemand moet er iets mee dóen. Dat vraagt een keuze, een investering en dus een ondernemer, en het zet 5.3 (wat kun je erin doen) en 5.4 (wie doet het) op hun plek. **De titel is om dezelfde reden veranderd**: "de kans zit waar de klem het strakst zit" beloofde de conclusie en riep bovendien de tegenwerping op dat de kans dan het grootst is waar niemand kan investeren.*

### 5.3 Waar deze opgaven een product kunnen worden · **gehaald: 976 woorden, 745 leesregel** (was 789)
...
*De sectie is per route korter dan op 19-8 maar in totaal 93 woorden langer, en dat is de prijs van de vierde route. **Eén tegenspraak staat in de fiche en niet in de tekst:** concept 8a zegt dat vernatting de eigen watervraag met 30 tot 40 procent verhoogt, Niel/UvW zegt een factor anderhalf tot drie. Die cijfers verdragen elkaar niet en zijn niet naast elkaar gelegd; dat hoort in de cijferbijlage te worden uitgezocht.*

### 5.4 En daarom een ondernemende boer · **gehaald: 693 woorden** (was 373 plus ±150 verhuisd, budget 450)
...
*Twee besluiten van 20-8 die je hier terugziet. **De inzet met de drie aktes is uit deze sectie gehaald** en staat als openingskader boven 6.1, want 6.1 gaat alleen over akte I. **En het element "geen verwijt aan wie niets doet" is vervallen**: het veronderstelde zelf dat iemand niets doet, en de erkenning hierboven doet dat werk concreter. Wat blijft is de vangrail zelf, en die zit nu in de eerste twee elementen.*

### 6.2 Waarom dit geen stabiele toestand is · budget 280
- **het lijkt te werken zolang de melkprijs meezit:** één product op één markt is een kwetsbare positie, en zij wordt pas zichtbaar bij de volgende schok in soja, kunstmest, melkprijs, klimaat of regelgeving `[tekst · verhuisd + bijgesteld]` de bewaarde tekst in `correctielijst.md` opent met "akte I lijkt te werken omdat er nog niks is gebeurd". **Die halve zin gaat eruit** (Tim, 20-8) en niet omdat hij scherp is: hij spreekt 5.1 letterlijk tegen, waar staat dat aan de drie eisen "het hardst gewerkt" wordt, en hij is de zin waarin een overheid een verwijt leest. De kwetsbaarheid zelf blijft, en zij hangt aan het aantal producten en niet aan de vraag of er beleid is. Besluit 17-8 over de monocultuur valt hiermee samen
...
- **wat het bedrijf merkt: de sturing gaat van middelen naar doelen.** De eisen worden hard en gehandhaafd, en wat ertegenover staat vergoedt schade in plaats van een prestatie te betalen `[tekst · auteurs]` de compensatie-alinea van de auteurs, ingedikt en met de vier labels erin. **De as is dezelfde als in 6.1** (Tim, 20-8): akte I stuurt op middelen, akte II op doelen, en dat woord gebruikt de bestuursversie zelf al. **Drie dingen moeten om:** de kop "Ingrijpen zonder pijlers", de openingszin "De overheid grijpt in met harde maatregelen" (toetsregel 12b, en dit is de zin waar het bestuur over viel), en "De overheid ziet de rode dimensies uit akte I en grijpt in" — dat maakt akte II een reactie op akte I en dus een oordeel. Wat er komt te staan is het mechanisme: er wordt op doelen gestuurd. De juridische uitleg over nadeelcompensatie wordt een fiche; "minimaal -40 cm" wordt "-20 tot -40 cm" *(Simon)*
...
- wie er door deze kanteling aan tafel komt `[tekst · verhuisd]` uit hoofdstuk 5
...
- de lijst wordt opgezocht en niet gelezen; in de tekst doet een fiche bij het eerste gebruik het werk `[fiche]`
