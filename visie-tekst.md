...
Deze visie verschijnt in meer dan één vorm. Er komt een korte versie die de kern in enkele zinnen geeft, en een leesversie die het verhaal doorlopend vertelt, apart voor beleidsmedewerkers en voor boeren. Dit stuk is het naslagwerk: de volledige redenering, met de cijfers, de bronnen en de afbakeningen erbij. Kern, feiten en positie tegenover het beleid zijn in alle versies gelijk; alleen de ingang en wat er weggelaten wordt, verschillen. Wie snel wil weten waar het over gaat, is met de korte versie klaar. Wie het moet kunnen verdedigen, is hier op de juiste plek.
