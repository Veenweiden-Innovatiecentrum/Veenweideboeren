...
| scenario-1 | 6 | 2 | **vier secties (20-8): 6.1 wat dit scenario is · 6.2 er wordt gestuurd op middelen · 6.3 waarom dit geen stabiele toestand is · 6.4 de motor.** 6.1 en 6.2 geschreven; 6.3 en 6.4 dragen hun nummer en titel maar staan er nog als bestuursversie. Uit de kaartvorm, met de scenariotabel en de illustratie in 6.1. De dimensielijst staat onderaan en gaat naar hoofdstuk 9. Start bij `richtlijnen/handoff-deel-3-scenarios.md` |
| scenario-2 | 7 | 2 | **vier secties (20-8): 7.1 wat dit scenario is · 7.2 de maatregelen kloppen, er ligt alleen niets onder · 7.3 waarom het bedrijf dat niet kan dragen · 7.4 de motor.** Alleen 7.1 is geschreven; de rest staat er als bestuursversie onder de juiste kop. De vier driesporenkaders staan er nog en gaan naar bijlage 17; de dimensielijst gaat naar hoofdstuk 9 |
| scenario-3 | 8 | 1 | herzien; **op 20-8 opnieuw gesneden naar vier secties**: 8.1 wat dit scenario is (nieuw) · 8.2 de omslag · 8.3 twee geldstromen · 8.4 de motor. De sectie "wat dat betekent per opgave" is opgeheven; de dimensielijst en het ontwikkelbeeld staan onderaan, klaar voor hoofdstuk 9. Open punt in de beeldlijst: tweede pijl voor de markt in het kernbeeld |
