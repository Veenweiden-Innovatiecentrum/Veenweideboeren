...
- **de sectie sluit op de as die de vier onderscheidt: hoeveel er van het bedrijf verandert.** Wonen en waterberging zijn erbij te doen op een deel van de grond; biodiversiteit en koolstof vastleggen zijn in de uitwerking hele bedrijven waar het vee beheerinstrument wordt of verdwijnt. Geen rangorde maar de schaal van 9.2 `[tekst · nieuw]` **Dit lost de spanning met 5.4 op** ("dit is geen omschakeling"): dat geldt voor twee van de vier. De getallen en ontwikkelniveaus staan in een fiche, want het zijn hypothesen op niveau 0,1 tot 0,2
