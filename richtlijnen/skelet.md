...
- **en de vraag die de lezer dan stelt, staat hier expliciet open:** betaalt iemand daarvoor? Het antwoord is niet "ja" maar "voor drie ervan is er een afnemer", en dat is 5.3 `[tekst · nieuw]` één zin, en zij is er om te voorkomen dat de kans op behoefte alleen rust
...
*Hoofdstuk 5 is af op **1.695 woorden totaal en 1.504 aan leesregel**, tegen 2.025 in de bestuursversie. Het budget van 1.560 is dus gehaald op de leesregel. Waar de winst zit: de tegenwerping "maak er dan helemaal natuur van" en de ruimtedruk uit de Ontwerp-Nota Ruimte zijn het hoofdstuk uit (samen ±280 woorden, geparkeerd in `correctielijst.md` onder `h-risicos` en `scope`), de drie horden zijn van 185 naar 70 woorden gegaan, en de opening van 5.3 en het stippenblokje bij piekberging zijn eruit. **5.4 staat 70 woorden over zijn budget** en dat laat ik zo: de sectie draagt vier bewegingen en de laatste zin van de hele analyse. **Hoofdstuk 4 en 5 samen: 2.814 woorden totaal tegen 2.857, en 2.502 aan leesregel** — dus ruim 300 korter op de regel die de lezer volgt, en gelijk als je de fiches meetelt.*
