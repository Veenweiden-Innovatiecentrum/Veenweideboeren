...
<p style="margin:0 0 1.4rem">
    ...
    <strong>Wat er moet gebeuren om dit te laten werken.</strong> Er moet één private partij zijn die daadwerkelijk betaalt, met een contract dat navolgbaar is voor de volgende. Dat weerlegt tegelijk het weerwoord dat dit subsidie met een ander etiket is.
  </p>

<p style="margin:0 0 1.4rem">
    <strong>Aanname 3 · De middengroep is het onderwerp van deze visie</strong><br>
    Wij denken dat juist de middengroep de groep is die deze omslag gaat maken: de familiebedrijven van 40 tot 80 hectare met 80 tot 130 koeien, die 70 tot 80 procent van het gebied beslaan. Zij zijn het onderwerp van dit document, en dat is een keuze. Schuift het percentage, dan schuift de doelgroep niet mee.<br>
    ...
    <strong>Wat er moet gebeuren om dit te laten werken.</strong> Deze groep moet de omslag zelf willen maken. Een deel wil simpelweg boer blijven zoals altijd, en hoofdstuk 14 rekent daarmee. En het percentage moet onderbouwd worden, want dat is minder hard dan de vaststelling zelf: het is nooit uitgezocht [[CIJFER: onderbouwing van het aandeel van de middengroep, 70 tot 80 procent; niet bevestigd en niet weerlegd]] en het wordt in dit document in twee betekenissen gebruikt, het aandeel in het aantal bedrijven en het aandeel in het areaal dat zij beheren. [[KEUZE: geldt de 70 tot 80 procent het aantal bedrijven of het beheerde areaal? Het document gebruikt nu beide]] 
  </p>
