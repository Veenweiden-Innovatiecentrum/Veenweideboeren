...
<div class="decision-card" style="margin-bottom:12px">
    ...
    <p style="font-size:13.5px;line-height:1.65;margin:.55rem 0 0"><strong>Wat wij zien.</strong> De vorm van de populatie, beschreven in hoofdstuk 3. De hele grote bedrijven, met meer dan 250 koeien en een groei richting 500 en meer, ondernemen op volume en hebben het kapitaal om die weg verder te gaan. De kleine nichebedrijven, onder de 70 koeien, hebben hun eigen markt, waar marge en een bijzonder product het werk doen. Beide hebben een werkend bedrijfsmodel en hebben deze visie niet nodig. Daartussen zit de groep die het meeste land beheert en geen van beide routes open heeft; daar moet dus een ander model vandaan komen. De maten zijn onze eigen typologie, uitgewerkt in hoofdstuk 9.</p>
...
**Organische mest voor de akkerbouw.** Veenweidebedrijven produceren mest in een hoeveelheid en kwaliteit die akkerbouwgebieden juist missen, zeker met het oog op bodemverbetering. Wat in de huidige logica nog regelmatig als mestoverschotprobleem wordt geframed, wordt in deze logica een gebiedsoverstijgende dienstenstroom: van veengebied naar akkerbouwgebied, met economische en bodembiologische winst aan beide kanten. De strakkere mestnormen van na de derogatie maken deze stroom voorwaardelijker — minder ruimte per hectare, preciezere balans van stikstof en fosfaat — maar de complementariteit zelf blijft: veen heeft de organische stof die de akkerbouw mist. Een gesloten kringloop is het niet: zolang een deel van het voer van buiten Europa komt, is die organische stof niet in dit gebied gegroeid.
...
Wat er eerst gebeurt is het grondbeleid. Dat stopt de grondhonger uit akte II: een grondbank vangt de waardedaling door vernatting op, zodat familiebedrijven niet gedwongen zijn te verkopen. Transitiesteun overbrugt de kwetsbare eerste jaren tot de contracten lopen, en de bergboerenregeling, de Europese regeling die bedrijven in gebieden met een natuurlijke handicap een structurele basisvergoeding geeft, biedt daarbij basiszekerheid.
  ...
  <div style="background:var(--bg3);border:1px solid rgba(0,0,0,.08);border-left:3px solid var(--blue);border-radius:var(--radius);padding:1.25rem 1.5rem;margin:1.25rem 0;font-size:13.5px;line-height:1.65">
      ...
      <p style="margin:0 0 .75rem">Er zijn drie tempo's tegelijk in beweging, en zij lopen niet gelijk. <strong>Politieke tijd</strong> loopt in jaren tot decennia — wetgeving, EU-richtlijnen, instrumentontwikkeling. <strong>Ondernemerstijd</strong> loopt in maanden tot jaren — marge, pacht, investeringshorizon. <strong>Systeemtijd</strong> loopt in fasen — agroketens 2-3 jaar, banken 3-5, marktpartijen voor maatschappelijke diensten 7-15. Akte II synchroniseert deze tempo's niet; daarom valt de ondernemer weg voordat het beleid uitontwikkeld is.</p>
      <p style="margin:0 0 .75rem">Akte III versnelt politieke tijd niet en vertraagt ondernemerstijd niet — het koppelt ze. Transitiesteun overbrugt ondernemerstijd zolang politieke tijd loopt. Prestatiecontracten van 10-20 jaar synchroniseren ondernemerstijd met systeemtijd. Hoofdstuk 12 mobiliseert systeemtijd binnen de termijn die ondernemerstijd vraagt. De tempo's worden in elkaar geschoven.</p>
...
[[TODO: 8.2 tot 8.4 zijn nog de bestuursversie. Wat er hier nog moet gebeuren, in de volgorde van het skelet: het woord "pijlers" vervalt (toetsregel 27), het kernbeeld krijgt een tweede pijl voor de markt (toetsregel 26), water wordt het voorbeeld waar een afnemer met een eigen belang zit (besluit 18-8), en de slotzin "wat de overheid nu doet bereikt het tegenovergestelde effect" moet om (toetsregel 1 en 12b). De twee driesporenkaders zijn 19-8 naar bijlage 16 verhuisd.]]
